...
export class Backend implements backendInterface {
    ...
    async createInquiry(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string | null): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createInquiry(arg0, arg1, arg2, arg3, to_candid_opt_n3(this._uploadFile, this._downloadFile, arg4));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteFeatureBox(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteFeatureBox(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async filterInquiriesBySubject(arg0: string): Promise<Array<Inquiry>> {
        if (this.processError) {
            try {
                const result = await this.actor.filterInquiriesBySubject(arg0);
    ...
    async getAllFeatureBoxes(): Promise<Array<FeatureBox>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllFeatureBoxes();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveFeatureBox(arg0: bigint | null, arg1: FeatureBox): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.saveFeatureBox(to_candid_opt_n11(this._uploadFile, this._downloadFile, arg0), arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_vec_n4(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Inquiry>): Array<Inquiry> {
    return value.map((x)=>from_candid_Inquiry_n5(_uploadFile, _downloadFile, x));
}
